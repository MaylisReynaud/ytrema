...
INSERT INTO "haberdashery"("name", "website", "haberdashery", "quantity", "price", "size", "unity", "color", "precise_color", "photo", "is_cut", "member_id")
    ...
    ('Boucle de ceinture Métal 3 points', 'https://atelierbrunette.com/', 'Boucle de ceinture', 2, 3.40, 18, 'mm', 'Bronze', '-', 'https://firebasestorage.googleapis.com/v0/b/ytrema-f6e59.appspot.com/o/images%2Fboucle-metal-3-points.jpg?alt=media&token=5d1ccc1c-d842-4014-90b2-7db956a17124', false, 2),
    ...
    ('Bouton métal dorés', 'https://www.mondialtissus.fr/', 'Bouton', 3, 3.99,  11, 'mm', 'Or', '-', 'https://firebasestorage.googleapis.com/v0/b/ytrema-f6e59.appspot.com/o/images%2Fboutons%20metal%20dore%2011mm.jpg?alt=media&token=0be4b42b-6dc5-4afc-8657-2696813a4076', false, 2),
    ('Fermeture polyester non séparable à glissière - Gris bleu', 'https://www.mondialtissus.fr/', 'Fermeture éclair', 1, 0.99, 200, 'mm', 'Gris', 'Gris-Bleu', 'https://firebasestorage.googleapis.com/v0/b/ytrema-f6e59.appspot.com/o/images%2Ffermeture%20glissiere%20gris%20bleu.jpg?alt=media&token=0727f6d6-624a-4879-bfc0-523ece31eb17', false, 1),
    ...
    ('Bobine Gutermann 250m col. 417', 'https://www.mondialtissus.fr/', 'Fil à coudre', 1, 4.99, 25000, 'mm', 'Jaune', '-', 'https://firebasestorage.googleapis.com/v0/b/ytrema-f6e59.appspot.com/o/images%2Ffil-250-m-417.jpg?alt=media&token=d3478a57-f068-490c-8987-30f4f5cf5a44', true, 2),
    ...
    ('Bobine Gutermann 250m col. 800', 'https://www.mondialtissus.fr/', 'Fil à coudre', 1, 4.99, 25000, 'mm', 'Blanc', '-', 'https://firebasestorage.googleapis.com/v0/b/ytrema-f6e59.appspot.com/o/images%2Ffil-250-m-800.jpg?alt=media&token=88f0cf91-4f1a-40a5-ae12-abc3f905675b', true, 2),
    ('Bobine Gutermann 250m col. 800', 'https://www.mondialtissus.fr/', 'Fil à coudre', 1, 4.99, 25000, 'mm', 'Blanc', '-', 'https://firebasestorage.googleapis.com/v0/b/ytrema-f6e59.appspot.com/o/images%2Ffil-250-m-800.jpg?alt=media&token=88f0cf91-4f1a-40a5-ae12-abc3f905675b', true, 2),
    ('Elastique Oekot', 'https://www.mondialtissus.fr/', 'Elastique lingerie', 1, 0.99, 400, 'mm', 'Blanc', '-', 'https://firebasestorage.googleapis.com/v0/b/ytrema-f6e59.appspot.com/o/images%2Felastique%20jupe%20souple%20blanc%2040mm.jpg?alt=media&token=7af15886-ecef-4346-b2db-92ce4bfb8480', true, 2);
...
INSERT INTO "fabric"("name", "website", "designer", "color", "precise_color", "fabric", "composition", "weight", "quantity", "width", "price", "photo", "member_id")
    ...
    ('Felin', 'https://www.hysope-tissus.fr/', 'Hysope', 'Multicolor', 'Blanc-Curry-Rose-Noir', 'Satin de coton Bio', '100 % coton', 130, 190, 150, 24.90, 'https://firebasestorage.googleapis.com/v0/b/ytrema-f6e59.appspot.com/o/images%2Ffelin%20hysope.jpg?alt=media&token=2a8f1a79-d810-41d8-99fa-b89ffc12b837', 1),
    ...
    ('Felin', 'https://www.hysope-tissus.fr/', 'Hysope', 'Blanc', 'Blanc-Curry-Rose-Noir', 'Satin de coton Bio', '100 % coton', 130, 190, 150, 24.90, 'https://firebasestorage.googleapis.com/v0/b/ytrema-f6e59.appspot.com/o/images%2Ffelin%20hysope.jpg?alt=media&token=2a8f1a79-d810-41d8-99fa-b89ffc12b837', 2),
    ...
    ('Felin', 'https://www.hysope-tissus.fr/', 'Hysope', 'Blanc', 'Blanc-Curry-Rose-Noir', 'Satin de coton Bio', '100 % coton', 130, 190, 150, 24.90, 'https://firebasestorage.googleapis.com/v0/b/ytrema-f6e59.appspot.com/o/images%2Ffelin%20hysope.jpg?alt=media&token=2a8f1a79-d810-41d8-99fa-b89ffc12b837', 3),
    ...
    ('Felin', 'https://www.hysope-tissus.fr/', 'Hysope', 'Multicolor', 'Blanc-Curry-Rose-Noir', 'Satin de coton Bio', '100 % coton', 130, 190, 150, 24.90, 'https://firebasestorage.googleapis.com/v0/b/ytrema-f6e59.appspot.com/o/images%2Ffelin%20hysope.jpg?alt=media&token=2a8f1a79-d810-41d8-99fa-b89ffc12b837', 4),
