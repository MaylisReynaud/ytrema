...
INSERT INTO "haberdashery"("id", "name", "website", "haberdashery", "unit_qty", "purchase_qty", "stock_qty","price", "size", "color", "precise_color", "unity", "is_cut", "is_a_set","member_id")
    OVERRIDING SYSTEM VALUE
    VALUES(1, 'Bouton Canopy Cactus', 'https://atelierbrunette.com/', 'Bouton', null, 1, 4, 1.20, 10, 'Vert', 'vert cactus', 'mm', false, false, 1);

INSERT INTO "review"("id", "content", "member_id")
    OVERRIDING SYSTEM VALUE
    VALUES(1, 'Je suis ravie de ce site', 1);

INSERT INTO "fabric"("id", "name", "website", "designer", "color", "precise_color", "fabric", "composition", "weight", "purchase_qty", "stock_qty","width", "price", "photo", "member_id")
    OVERRIDING SYSTEM VALUE
    VALUES(1, 'Crepe Cactus', 'https://atelierbrunette.com/', 'Atelier Brunette', 'Vert', 'Vert cactus', 'Viscose', '100 % viscose', 118, 150, 150, 140, 14.40, 'https://m1.atelierbrunette.com/9564-large_default/tissu-crepe-cactus.jpg', 1);
