...
# rdv sur http://localhost:8080/ pour vérifier que ça tourne bien

# puis ajuster package.json, src/assets/index.html et src/components/App/index.js
# ET FAIRE UN PREMIER COMMIT avant d'attaquer le travail concret sur le projet :)
```
